...
class YOLO(object):
    _defaults = {
        "model_path": 'E:/YOLOv3-tiny/logs/best_weights.h5',
        "anchors_path": 'E:/YOLOv3-tiny/model_data/tiny_yolo_anchors.txt',
        "classes_path": 'E:/YOLOv3-tiny/model_data/voc_classes.txt',
    ...
    def detect_image(self, image):
        ...
        print(end - start)
        # output = os.path.join(output_path, 'result.jpg')
        # cv2.imwrite(output, np.asarray(image))
        return image
